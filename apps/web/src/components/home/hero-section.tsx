    ...
    <section className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 pt-20">
        <div className="max-w-3xl">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif mb-6 leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-1000">
            Light,<br /><span className="italic text-accent">measured.</span>
          </h1>
          <p className="text-lg md:text-xl font-light text-foreground/80 mb-10 max-w-xl leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-150">
            We treat window dressings like architecture. No catalogs, no guessing sizes.
            Our advisors measure, craft, and fit every shade exactly to your space.
          </p>
